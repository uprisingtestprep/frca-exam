/* FRCA Exam Simulator, Application Logic */

const ACCESS_CODE  = "FRCA9000";
const EXAM_SECONDS = 10800;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "frca_exam_state_v1";
const SIM_Q_COUNT  = 90;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"pharmacology": "Pharmacology", "physiology_anatomy_and_biochemistry": "Physiology Anatomy and Biochemistry", "physics_clinical_measurement_and_data_interpretation": "Physics Clinical Measurement and Data Interpretation"};  // maps domain key -> human-readable label for display
